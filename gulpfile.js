...
gulp.task('js', function(){
  return gulp.src((env.p) ? 'static/js/*.js' : ['static/js/*.js', '!src/js/analytics.js'])
    .pipe(plumber())
    .pipe(concat('*.js'))
    .pipe(uglify())
    .pipe(gulp.dest('_site/assets/js/main.js'));
});
 ...
 */
gulp.task('default', ['js', 'stylus', 'jekyll-rebuild', 'browser-sync', 'watch']);
