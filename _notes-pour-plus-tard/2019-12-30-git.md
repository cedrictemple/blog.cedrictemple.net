...
Vous pouvez annuler plusieurs commits consécutifs mais toujours **si vous ne les avez pas poussé sur le repo distant**. Pour cela, identifier le numéro de commit précédent vers lequel revenir à l'aide de la commande git log puis l'indiquer. Exemple :
``` bash
